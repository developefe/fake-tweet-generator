...
const RetweetIcon = ({color, width, height}) => {
    return(
        ...
        height={height || "24"}
        viewBox="0 0 24 24" 
        aria-hidden="true"  class="r-4qtqp9 r-yyyyoo r-50lct3 r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-1srniue">
            <g>
...
const ShareIcon = ({color, width, height}) => {
    return(
        ...
        viewBox="0 0 24 24" 
        aria-hidden="true" 
        class="r-4qtqp9 r-yyyyoo r-50lct3 r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-1srniue" data-testid="iconOutgoing">
            <g>
